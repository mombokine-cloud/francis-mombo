...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "hypnose performance sportive",
    "hypnose stress compétition",
    "hypnose confiance en soi sportif",
    "hypnothérapeute sportif Castelnau-le-Lez",
  ],
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12 lg:py-20">
        ...
        <article className="space-y-10 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <ul className="article-list">
              ...
              <li>travailler sur les croyances limitantes ("je ne suis pas capable", "je craque toujours sous pression").</li>
            </ul>
          </section>
        ...
        <div className="mt-10 p-5 bg-gray-50 rounded-xl">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/hypnose-therapeutique" className="text-xs font-semibold px-3 py-2 rounded-full border border-gray-200 text-gray-600 hover:border-pink-300 hover:text-pink-600 transition-colors">Hypnose thérapeutique</Link>
        ...
        <div className="mt-10 rounded-2xl p-8 text-center" style={{ background: "linear-gradient(135deg, #fdeef3, #fff3e8)" }}>
          ...
          <p className="text-gray-500 text-sm mb-6 max-w-md mx-auto">Préparation mentale par l'hypnose pour sportifs amateurs et de compétition à Castelnau-le-Lez.</p>
