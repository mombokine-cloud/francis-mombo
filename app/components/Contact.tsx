          ...
          <div className="space-y-6">
            ...
            >
              ...
              {[
                ...
                { Icon: Mail, label: "Email", value: "contact@mombofrancis.com", href: "mailto:contact@mombofrancis.com" },
          ...
          <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
            {status === "sent" ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 text-sm">Francis vous répondra dans les meilleurs délais.</p>
              </div>
            ) : (
