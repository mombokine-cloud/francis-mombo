...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "hypnose douleur chronique",
    "hypnose phobies",
    "hypnose troubles du sommeil",
    "hypnose thérapie brève Montpellier",
  ],
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12 lg:py-20">
        <div className="mb-10">
          ...
          <p className="text-gray-500 text-lg leading-relaxed">
            L'hypnose thérapeutique est une approche complémentaire qui permet d'accéder aux ressources inconscientes pour dépasser des blocages, gérer la douleur, réduire le stress ou modifier des comportements limitants. Francis MOMBO est formé à l'hypnose médicale et à la thérapie brève orientée solution.
          </p>
        </div>
        ...
        <article className="space-y-10 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-3">
              <Link href="/hypnose-sport" className="font-semibold underline" style={{ color: "#D4336E" }}>
                Découvrir la page dédiée : Hypnose & performance sportive →
              </Link>
            </p>
          </section>
          ...
          <section>
            ...
            <p>La séance débute par un entretien pour définir l'objectif thérapeutique. L'induction hypnotique est ensuite guidée par la voix de Francis MOMBO. Le travail thérapeutique se déroule dans cet état de conscience modifié, puis une phase de retour progressif clôture la séance. Durée : 45 à 60 minutes.</p>
          </section>
        ...
        <div className="mt-10 p-5 bg-gray-50 rounded-xl">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/hypnose-sport" className="text-xs font-semibold px-3 py-2 rounded-full border border-gray-200 text-gray-600 hover:border-pink-300 hover:text-pink-600 transition-colors">Hypnose & sport</Link>
        ...
        <div className="mt-10 rounded-2xl p-8 text-center" style={{ background: "linear-gradient(135deg, #fdeef3, #fff3e8)" }}>
          ...
          <p className="text-gray-500 text-sm mb-6 max-w-md mx-auto">Séances d'hypnose thérapeutique à Castelnau-le-Lez et Saint-Mathieu-de-Tréviers.</p>
